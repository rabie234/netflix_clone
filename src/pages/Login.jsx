           ...
           <div className='fixed py-24 px-4 w-full  z-50'>
            <div className='bg-black/75 max-w-[450px] mx-auto h-[600px] text-white'>
                <div className='max-w-[350px] mx-auto py-16'>
                    ...
                    <button className='bg-red-600 rounded  py-3 my-6 font-bold'>LogIn</button>
              ...
              <div className='py-8'>
                <p className='text-sm text-gray-600'>You have no account yet <Link to='/singup'><span className='text-white'>Sing Up</span></Link></p>
              </div>
                </form>
                </div>
